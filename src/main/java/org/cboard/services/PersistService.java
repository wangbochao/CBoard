...
public class PersistService {
	...
	public PersistContext persist(Long dashboardId, String userId) {
		...
		try {
			...
			String phantomUrl = new StringBuffer("http://127.0.0.1:").append(web).append("render.html").append("?sid=")
					.append(uuid).append("#?id=").append(dashboardId).append("&pid=").append(persistId).toString();
